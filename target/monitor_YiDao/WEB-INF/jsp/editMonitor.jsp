								...
								<div class="set-argument">
									<span class="argu-list"> <b> <select name="requestAgreement"
											id="requestAgreement" class="check-option">
												...
												<option value="http-get" <c:if test="${monitorItems.requestAgreement=='http-post' || monitorItems.requestAgreement=='http-POST'}">selected = "selected"</c:if>>http-POST</option>
										</select> </b> </span>
								</div></td>
						</tr>
