...
<html>
  ...
  <script type="text/javascript">
			...
			function subForm() {
				$.get("/monitor_YiDao/contacts/addContacts", 
  ...
  <body>
					...
					<table width="100%" cellspacing="0" cellpadding="0" border="0"
						...
						<tr>
							...
							<td>
							 <input type="hidden" name="contactsSystem" value="${monitorSystem}">
							 ${monitorSystem}
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td style="vertical-align:middle;">
						   	<input type="radio" name="contactsStart" value="1" checked="checked"><span>启用</span>
							<input type="radio" name="contactsStart" value="0"><span>不启用</span>
							</td>
						</tr>
					</table>
				</form>
